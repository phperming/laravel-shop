...
class CouponCode extends Model
{
    ...
    public function checkAvailable(User $user,$orderAnount = null)
    {
    	//如果优惠券没有启用，等同于不存在
    	if (!$this->enabled)) {
    	...
    	if ($this->total - $this->used <=0 ) {
    		throw new CouponCodeUnavailableException('该优惠券已经用完');
    	}
